...
//	private static String passwd = "0000";
	...
	public static String setData(String dbName, String sql, String[] data) {
		...
		try {
			...
			System.out.println("sdata error! " + e.toString());
			try {
				if (con != null) {
					con.close();
				}
	...
	public static String setExamScore(String dbName, String sql, int quesNum, int rightNum, String id) {
		...
		try {
			...
			System.out.println("score error! " + e.toString());
			try {
				if (con != null) {
					con.close();
				}
	...
	public static String setData(String dbName, String sql) {
		...
		try {
			...
			System.out.println("s.data error! " + e.toString());
			try {
				if (con != null) {
					con.close();
				}
	...
	public static String delData(String dbName, String sql, String title, String id) {
		...
		try {
			...
			System.out.println("d.data error! " + e.toString());
			try {
				if (con != null) {
					con.close();
				}
	...
	public static String delData2(String dbName, String sql, String title, String id) {
		...
		try {
			...
			System.out.println("ddata2 error! " + e.toString());
			try {
				if (con != null) {
					con.close();
				}
	...
	public static boolean delAllData(String dbName, String sql) {
		...
		try {
			...
			System.out.println("dadata error! " + e.toString());
			try {
				if (con != null) {
					con.close();
				}
...
//				System.out.print("\n");
			...
			System.out.println("secdata error! " + e.toString());
			try {
				if (con != null) {
					con.close();
				}
