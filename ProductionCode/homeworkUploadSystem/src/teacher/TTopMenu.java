...
public class TTopMenu extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		pw.println("<A HREF=THomeworkBoard TARGET=DownMenu>[出作業</A> ");
//		pw.println("<A HREF='t_score_report.jsp' TARGET=DownMenu>作業通過統計</A> "); //2018/9/20 take out
		...
		pw.println("<A HREF=ExamBoard TARGET=DownMenu>[編修考題資料庫</A> "); //2019/10/08 take out
		pw.println("<A HREF=ChooseQuesType TARGET=DownMenu>出考題</A> "); //2019/10/08 take out
		pw.println("<A HREF=SetExamTime TARGET=DownMenu>設定考試時間</A> "); //2019/10/08 take out
		pw.println("<A HREF=DelExam TARGET=DownMenu>重新考試</A> "); //2019/10/08 take out
		pw.println("<A HREF=setScore TARGET=DownMenu>考試成績設定</A> "); //2019/10/08 take out
