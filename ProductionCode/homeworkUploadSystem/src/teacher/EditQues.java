...
public class EditQues extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		//ArrayList<Ques> allQues = Ques.getAllQues(tr.getDbName());
		if (tr == null) {
		...
		System.out.println("here size="+allQues.size());
		for(int k = 0; k< allQues.size(); k++) {
			System.out.println("here");
			ques = (ExamQuestion) allQues.get(k);
		...
		pw.println("<INPUT TYPE=submit VALUE=confirm>");
		pw.println("</FORM>");
