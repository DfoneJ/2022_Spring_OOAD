...
{	
//	private String SettingTxt = "/home/islab/eclipse/CPDSetting";//in server copyTest system, use this line(before export)
	private String SettingTxt = "/home/aaron/1-8work/CPDSetting";//in local copyTest system, use this line instead

	//	private String SettingTxt = "/home/lucas/eclipse-workspace/CPDSetting";	//存放設定的txt檔名稱
//	private String SettingTxt = "/home/islab/eclipse/CPDSetting";
    private String path = "";	//偵測路徑
    private String language = "C/C++";	//偵測對象語言
    private boolean detectedFile = false;	//檔案列表中是否至少有兩個檔案
    private boolean structureAnalyzer = false;	//是否使用結構分析
    private boolean variableAnalyzer = false;	//是否使用變數分析
